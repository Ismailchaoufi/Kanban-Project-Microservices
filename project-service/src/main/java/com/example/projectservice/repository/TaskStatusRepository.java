...
/**
 * Repository for managing task statuses
 */
@Repository
public interface TaskStatusRepository extends JpaRepository<TaskStatusEntity, Long> {
    ...
    /**
     * Find status by ID and project (for security - ensure status belongs to project)
     */
    Optional<TaskStatusEntity> findByIdAndProjectId(Long id, Long projectId);

    /**
     * Delete all statuses for a project (cascade when project is deleted)
     */
